...
import { ACTIVEIMG3 } from "../../misc/activeimg";
...
function Bentleyproduct() {
  const slides = ACTIVEIMG3;
      ...
      <div className="py-5 px-12 gap-12 flex">
        ...
        <div className="flex-1 flex-col flex gap-7">
          <h1 className="font-bold text-2xl">
            BENTLEY STRONG FRAGRANCE PERFUME{" "}
          </h1>
          <span className="text-[#a52a2a] text-[2rem] font-medium">
            #22,000
          </span>
          <p className="text-lg font-light text-justify">
            Bentley perfume with very good frangrance that last long for more
