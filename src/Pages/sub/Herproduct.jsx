...
import { ACTIVEIMG2 } from "../../misc/activeimg";
    ...
    <Mainlayout>
      <div className="py-5 px-12 gap-12 flex">
        ...
        <div className="flex-1 flex-col flex gap-7">
          <h1 className="font-bold text-2xl">HER STRONG FRAGRANCE PERFUME </h1>
          <span className="text-[#a52a2a] text-[2rem] font-medium">
            #13,000
          </span>
          <p className="text-lg font-light text-justify">
            Her perfume with very good frangrance that last long for more than
